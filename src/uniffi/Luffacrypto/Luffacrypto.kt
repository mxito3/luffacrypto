...
open class RustBuffer : Structure() {
    ...
    companion object {
        internal fun alloc(size: Int = 0) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_Luffacrypto_531d_rustbuffer_alloc(size, status).also {
                if(it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_Luffacrypto_531d_rustbuffer_free(buf, status)
        }
    }
...
internal interface _UniFFILib : Library {
    ...
    fun Luffacrypto_531d_new_aes_key(
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun Luffacrypto_531d_aes_encrypt(`originData`: RustBuffer.ByValue,`hexKey`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun Luffacrypto_531d_aes_decrypt(`ciphertext`: RustBuffer.ByValue,`hexKey`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun Luffacrypto_531d_des_encrypt(`originData`: RustBuffer.ByValue,`hexKey`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun Luffacrypto_531d_des_decrypt(`ciphertext`: RustBuffer.ByValue,`hexKey`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun Luffacrypto_531d_new_des_key(
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun Luffacrypto_531d_generate_avatar(`peerId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun Luffacrypto_531d_generate_nickname(`peerId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_Luffacrypto_531d_rustbuffer_alloc(`size`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_Luffacrypto_531d_rustbuffer_from_bytes(`bytes`: ForeignBytes.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_Luffacrypto_531d_rustbuffer_free(`buf`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun ffi_Luffacrypto_531d_rustbuffer_reserve(`buf`: RustBuffer.ByValue,`additional`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue
...
fun `newAesKey`(): String {
    ...
    rustCall() { _status ->
    _UniFFILib.INSTANCE.Luffacrypto_531d_new_aes_key( _status)
})
}
...
fun `aesEncrypt`(`originData`: String, `hexKey`: String): String {
    return FfiConverterString.lift(
    rustCall() { _status ->
    _UniFFILib.INSTANCE.Luffacrypto_531d_aes_encrypt(FfiConverterString.lower(`originData`), FfiConverterString.lower(`hexKey`), _status)
})
}
...
fun `aesDecrypt`(`ciphertext`: String, `hexKey`: String): String {
    return FfiConverterString.lift(
    rustCall() { _status ->
    _UniFFILib.INSTANCE.Luffacrypto_531d_aes_decrypt(FfiConverterString.lower(`ciphertext`), FfiConverterString.lower(`hexKey`), _status)
})
}
...
fun `desEncrypt`(`originData`: String, `hexKey`: String): String {
    return FfiConverterString.lift(
    rustCall() { _status ->
    _UniFFILib.INSTANCE.Luffacrypto_531d_des_encrypt(FfiConverterString.lower(`originData`), FfiConverterString.lower(`hexKey`), _status)
})
}
...
fun `desDecrypt`(`ciphertext`: String, `hexKey`: String): String {
    return FfiConverterString.lift(
    rustCall() { _status ->
    _UniFFILib.INSTANCE.Luffacrypto_531d_des_decrypt(FfiConverterString.lower(`ciphertext`), FfiConverterString.lower(`hexKey`), _status)
})
}
...
fun `newDesKey`(): String {
    return FfiConverterString.lift(
    rustCall() { _status ->
    _UniFFILib.INSTANCE.Luffacrypto_531d_new_des_key( _status)
})
}
...
fun `generateAvatar`(`peerId`: String): String {
    ...
    _UniFFILib.INSTANCE.Luffacrypto_531d_generate_avatar(FfiConverterString.lower(`peerId`), _status)
})
}
...
fun `generateNickname`(`peerId`: String): String {
    return FfiConverterString.lift(
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.Luffacrypto_531d_generate_nickname(FfiConverterString.lower(`peerId`), _status)
})
}
